...
export const HomeProcessSteps = ({ data }: HomeProcessStepsProps) => {
  ...
  return (
    <section
      ...
      className="relative isolate flex w-full flex-col items-center gap-7 px-4 pb-12 pt-20 md:items-center md:px-20 md:pb-24 md:pt-24 lg:items-start lg:gap-8 lg:px-8 lg:pb-24 lg:pt-24"
    >
