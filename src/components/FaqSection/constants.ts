...
/** Shared sesje-kobiece FAQ copy — same across gallery and offer-service pages. */
export const faqSesjeKobieceDefaults: FaqSectionData = {
  heading: {
    emphasis: 'Rozwiejmy',
