...
export type OfferProcessStepsData = {
  heading: {
...
/** Shared five-step copy — identical on home and offer-service variants. */
export const defaultOfferProcessStepItems: readonly OfferProcessStep[] = [
  {
    number: 1,
