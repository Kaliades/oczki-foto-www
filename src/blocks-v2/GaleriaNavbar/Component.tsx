...
export default function GaleriaNavbar() {
  return (
        ...
        <div className="flex flex-1 items-center justify-between">
          ...
          <div className="flex h-5 w-[82px] items-center gap-[3px]">
            <div className="relative h-[21.954px] w-[15.231px] shrink-0">
              <Image
                src="/blocks-v2/galerianavbar/sygnet.svg"
                alt=""
                fill
            ...
            <div className="relative h-[21.154px] w-[71.89px] shrink-0">
              <Image
                src="/blocks-v2/galerianavbar/logotyp.svg"
                alt=""
                fill
                className="object-contain"
              />
              ...
              <div className="relative size-[14px] overflow-hidden">
                <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]">
                  <div className="absolute inset-[-20.2%_-10.1%_-8.37%_-10.1%]">
                    <Image
                      src="/blocks-v2/galerianavbar/elements.svg"
                      alt=""
                      fill
                      className="object-contain"
                    />
          ...
          <div className="flex items-center">
            <div className="relative h-11 w-[18px] shrink-0">
              <Image
                src="/blocks-v2/galerianavbar/subtract-left.svg"
                alt=""
                fill
                className="object-contain"
              />
            ...
            <div className="relative h-11 w-[18px] shrink-0">
              <Image
                src="/blocks-v2/galerianavbar/subtract-right.svg"
                alt=""
                fill
                className="object-contain"
              />
